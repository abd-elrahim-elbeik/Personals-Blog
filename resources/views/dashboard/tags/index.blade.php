...
<body>
    ...
    <div style="margin-left: 30%; margin-right: 30%; margin-top: 10%">
        ...
        <a href="{{ route('tags.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>add</a>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#.</th>
            ...
            <tbody>
                @foreach ($tags as $index => $tag)
                    <tr>
                        ...
                        <td>{{ $tag->name }}</td>
                        <td>
                            <a href="{{ route('tags.edit', $tag->id) }}" class="btn bti-sm btn-outline-secondary"><i class="fa fa-edit"></i> Edit</a>
                        </td>
                        <td>
